...
if mode == 'train':
    ...
    if model_name == 'RippleNet':
        ...
        # get model
        a_model = importlib.import_module('experiments_carmen.{0}.model.model_fn'.format(model))
        # if model.find('CSD') != -1:
        ...
        params['WEIGHT_FILE'] = 'experiments_carmen/{0}/'.format(model_name)+'weights.last.h5'
        # params['WEIGHT_FILE'] = ''
        model = build_DBI_TCN(params["NO_TIMEPOINTS"], params=params)
